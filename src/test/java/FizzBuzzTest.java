...
public class FizzBuzzTest {
    ...
    //start < end, negative values
    @Test
    public void testStartEqualsEnd_StartAndEndLessZero_HappyPath() {
        ///AAA
        //arrange
        int start = -20;
        int end = -1;
    ...
    //1.Negative testing Unhappy path
    //if (start > end)
    //return new String[0];

    //start > end
    @Test
    public void testStartGreaterThenEnd_UnhappyPath() {
        ///AAA
        //arrange
        int start = 20;
        int end = 1;
